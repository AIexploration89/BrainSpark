          ...
          return (
            <motion.button
              ...
              className={`
                ...
                ${isSelected
                  ? 'bg-neon-cyan/20 border-neon-cyan text-neon-cyan shadow-[0_0_20px_rgba(0,245,255,0.3)]'
                  : 'bg-bg-secondary/60 border-white/10 text-white hover:border-neon-cyan/50 hover:bg-bg-secondary'
                }
