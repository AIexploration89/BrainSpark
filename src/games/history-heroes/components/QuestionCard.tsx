...
import { COMBO_MESSAGES, HISTORICAL_ERAS } from '../types';
...
export function QuestionCard({
  ...
  // Get era config for styling
  const eraConfig = HISTORICAL_ERAS.find(e => e.id === question.era);
  const accentColor = eraConfig?.accentColor || '#8B5CF6';
    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      >
        ...
        <div className="flex justify-center gap-2 mb-4">
          <span
            className="px-3 py-1 rounded-full text-xs font-display capitalize"
            style={{
          ...
          {question.year && (
            ...
            >
              🕰️ {question.year < 0 ? `${Math.abs(question.year)} BCE` : `${question.year} CE`}
            </span>
          )}
        </div>
          ...
          >
            ...
            <div className="bg-bg-primary/50 rounded-xl p-4 mb-4">
              <p className="text-text-secondary text-sm leading-relaxed">
                <span style={{ color: accentColor }} className="font-display font-bold">📜 Did you know? </span>
            ...
            <motion.button
              ...
              className="w-full py-3 rounded-xl font-display font-bold uppercase tracking-wider text-white shadow-lg"
              style={{
                ...
                >
                  <div className="flex items-center gap-3">
                    <span
                      ...
                      `}
                      style={isSelected ? { background: accentColor, color: '#0a0a0f' } : {}}
                    >
                      {letters[index]}
                    </span>
